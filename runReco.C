...
void runReco(TString inFile = "evetestBOX.root", TString outFile = "mpddst.root", Int_t nStartEvent = 0,
             Int_t nEvents = 100, ETpcClustering tpcClusteringModule = ETpcClustering::MLEM,
