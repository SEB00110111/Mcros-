...
void runMC(EGenerators generator = EGenerators::BOX, EVMCType vmc = EVMCType::GEANT4, Int_t nStartSeed = 0,
           TString inFile = "/home/maldonado/Software/urqmd-3.4/testfxt.f14", TString outFile = "evetestBOX.root", Int_t nStartEvent = 0,
           Int_t nEvents = 10, Bool_t flag_store_FairRadLenPoint = kFALSE, Int_t FieldSwitcher = 0)
{
   TStopwatch timer;
   timer.Start();
   gDebug = 0;
   ...
   {
      gRandom->SetSeed(0);
      FairBoxGenerator *boxGen = new FairBoxGenerator(partPdgC[5], 100);
